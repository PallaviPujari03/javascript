...
console.log('-----------------Using arrow with no args and no return value => ----------------');
let myFunction = () => {
...
let multiply = (n1,n2,n3) => {
     var result=(n1*n2*n3);
     console.log(`multiplication of 3 number is : ${n1} * ${n2} * ${n3} = ${result}`);
}

multiply(5,5,2)


console.log('--------------------invoke the same function for the values----------------------');
let show = (n1,n2,n3=1) => {
     var result=(n1*n2*n3);
     console.log(`multiplication of 3 number is : ${n1} * ${n2} * ${n3} = ${result}`);
}
...
let add = (n1,n2,n3,n4,n5) => {
     ...
     console.log(`addition  of 5 numbers is : ${n1} + ${n2} + ${n3} + ${n4} + ${n5}  = ${result}`);
}
add(100,100,200,349,756)


console.log('--------------------same arrow function for values----------------------');
